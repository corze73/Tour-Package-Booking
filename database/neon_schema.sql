-- Adventure Tours Database Schema for Neon PostgreSQL
-- This replaces the MySQL schema for Netlify + Neon deployment
...
CREATE TABLE tours (
    ...
    difficulty_level VARCHAR(20) DEFAULT 'Easy' CHECK (difficulty_level IN ('Easy', 'Moderate', 'Challenging', 'Expert')),
    includes TEXT,
    excludes TEXT,
    itinerary TEXT,
...
(1, 'Sarah Johnson', 'sarah@email.com', 4, 'Great trek but quite challenging. Make sure you are physically prepared. The accommodation was comfortable.', 'approved'),
